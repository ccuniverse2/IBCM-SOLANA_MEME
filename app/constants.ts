...
export const LOANS_TYPES: LoanType[] = [
  {
    ...
    ui_period_duration_display_string: '2 months, pay IBC instantly to Solana Wallet',
  },
  {
    ...
    ui_period_duration_display_string: '11 months, pay IBC instantly to Solana Wallet',
  },
  {
  period_duration_in_seconds: 3, // payment every 3s (for testing only)
   ...
   ui_period_duration_display_string: '12 seconds, pay instantly 3 seconds',
 },
]
